...
arms_100 %>%
  ...
  head(n = 10) %>%
  kable(caption = "Arms Manufacturing Companies With the Greatest Increase in Arms Sales, 2015-16 (Figures in millions of US$)", col.names = c("Company", "Arms Sales Increase"), digits = 1) %>%
  kable_styling(bootstrap_options = "hover")
...
arms_100 %>%
  ...
  head(n = 10) %>%
  kable(caption = "Highest Arms Manufacturing Sales by Country, 2016 (Figures in millions of US$)", col.names = c("Country", "Arms Sales in 2016")) %>%
  kable_styling(bootstrap_options = "hover")
```
